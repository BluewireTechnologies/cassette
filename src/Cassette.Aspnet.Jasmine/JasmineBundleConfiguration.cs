...
namespace Cassette.Aspnet.Jasmine
{
    public class JasmineBundleConfiguration : IConfiguration<BundleCollection>
    {
        ...
        ScriptBundle CreateScriptBundle()
        {
            ...
            script.Assets.Add(new ResourceAsset("Cassette.Aspnet.Jasmine.jasmine_5_7_1.jasmine.js", GetType().Assembly));
            script.Assets.Add(new ResourceAsset("Cassette.Aspnet.Jasmine.jasmine_5_7_1.jasmine-html.js", GetType().Assembly));
            script.Assets.Add(new ResourceAsset("Cassette.Aspnet.Jasmine.jasmine_5_7_1.boot0.js", GetType().Assembly));
            script.Assets.Add(new ResourceAsset("Cassette.Aspnet.Jasmine.jasmine_5_7_1.boot1.js", GetType().Assembly));
            return script;
        }
        ...
        StylesheetBundle CreateStylesheetBundle()
        {
            ...
            css.Assets.Add(new ResourceAsset("Cassette.Aspnet.Jasmine.jasmine_5_7_1.jasmine.css", GetType().Assembly));
            return css;
        }
    }
}